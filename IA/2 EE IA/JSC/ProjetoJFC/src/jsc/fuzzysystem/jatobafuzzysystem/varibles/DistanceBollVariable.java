...
public class DistanceBollVariable extends FuzzyVariable {

	@Override
	public void buildFuzzyVariable() {
		
		FuzzySet high = new FuzzySet(Term.NONE,new TrapezoidalMembershipFunction(0.0,0.0,1.0,2.0));
		FuzzySet mean = new FuzzySet(Term.NEAR,new TrapezoidalMembershipFunction(1.0,2.0,4.0,5.0));
		FuzzySet low = new FuzzySet(Term.FAR,new TrapezoidalMembershipFunction(4.0,5.0,10.0,10.0));
